...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    local elements = {}
	  ...
	  table.insert(elements, { label = 'Radiobil - Volvo XC90', value = 'xc90pol'})
      table.insert(elements, { label = 'Radiobil - Volkswagen Passat R-Line', value = 'police3'})
      table.insert(elements, { label = 'Radiobil - Volkswagen Transport T5', value = 'policevw'})
      table.insert(elements, { label = 'Civilbil - Volvo XC70', value = 'police4'})
      table.insert(elements, { label = 'Civilbil - Volvo V90', value = 'fbi'})
      table.insert(elements, { label = 'Civilbil - Volvo V70', value = 'fbi2'})    
      table.insert(elements, { label = 'Motorcyckel - BMW R1200RT', value = 'policeb'})
      table.insert(elements, { label = 'Insatsstyrkan Van', value = 'insats'})
...
Citizen.CreateThread(function()
    while true 
        ...
        SetPedDensityMultiplierThisFrame(0.51)
        SetRandomVehicleDensityMultiplierThisFrame(0.71)
        SetParkedVehicleDensityMultiplierThisFrame(1.41)
        SetScenarioPedDensityMultiplierThisFrame(0.21, 0.21)
