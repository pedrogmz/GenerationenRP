...
Config.PoliceStations = {
  ...
  LSPD1 = {
    ...
    AuthorizedVehicles = {
      {name = 'police' , label = '🚔 Radiobil: Volvo XC70 2010'},
      {name = 'police3', label = '🚔 Radiobil: Volvo XC70 2018'},
      {name = 'fbi', label = '🚔 Radiobil: Volvo V70'},
      {name = 'police2', label = '🚔 Radiobil: Volvo V90'},
      {name = 'sheriff', label = '🚔 Civilbil: Volvo XC70'},
    },

    Cloakrooms = {
      {x = 450.0, y = -993.0, z = 29.7},
      {x = 475.311, y = -991.729, z = 24.014}
    },

    Armories = {
      {x = 461.0, y = -982.5, z = 29.7}
    },

    Vehicles = {
      {
        Spawner    = {x = 454.69, y = -1017.40, z = 27.53},
    ...
    VehicleDeleters = {
			...
			{ x = 462.40, y = -1019.7, z = 27.110 }
    },

    BossActions = {
      {x = 448.417, y = -973.208, z = 29.7}
    }
