...
ESX.RegisterServerCallback('esx_andreas_blackmarket:requestDBItems', function(source, cb)

	MySQL.Async.fetchAll(
	'SELECT * FROM svartamarknaden',
	{},
	function(result)
		local shopItems  = {}
		for i=1, #result, 1 do
...
RegisterServerEvent('esx_andreas_blackmarket:buyItem')
AddEventHandler('esx_andreas_blackmarket:buyItem', function(itemName, price)
	...
	if price < 0 then
		print('esx_andreas_blackmarket: ' .. xPlayer.identifier .. ' attempted to cheat money!')
		return
	end
