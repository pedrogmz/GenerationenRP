...
Config.DoorList = {
	...
	[22] = { 
		...
		objCoords  = {x = -472.650, y = -368.532, z = -187.369},
		textCoords = {x = -472.650, y = -368.532, z = -186.0},
		locked = true,
	},

	[23] = { -- Sjukhus
		objName = "v_ilev_cor_doorglassa",
		objCoords  = {x = -473.749, y = -368.537, z = -187.369},
		textCoords = {x = -473.749, y = -368.537, z = -186.0},
		locked = true,
	},

	[24] = { -- Sjukhus
		objName = "v_ilev_cor_doorglassa",
		objCoords  = {x = -476.423, y = -360.598, z = -187.369},
		textCoords = {x = -476.423, y = -360.598, z = -186.0},
		locked = true,
	},

	[25] = { -- Sjukhus
		objName = "v_ilev_cor_doorglassa",
		objCoords  = {x = -475.253, y = -360.579, z = -187.369},
		textCoords = {x = -475.253, y = -360.579, z = -186.0},
		locked = true,
	},

	[26] = { -- Sjukhus
		objName = "v_ilev_cor_doorglassa",
		objCoords  = {x = -470.391, y = -372.712, z = -187.369},
		textCoords = {x = -470.391, y = -372.712, z = -186.0},
		locked = true,
	},

	[27] = { -- Sjukhus
		objName = "v_ilev_cor_doorglassa",
		objCoords  = {x = -470.398, y = -373.974, z = -187.369},
		textCoords = {x = -470.398, y = -373.974, z = -186.0},
		locked = true,
	},

	[28] = { -- Sjukhus
		objName = "v_ilev_cor_firedoor",
		objCoords  = {x = -461.776, y = -339.725, z = -187.369},
		textCoords = {x = -461.776, y = -339.725, z = -186.0},
		locked = true,
	},
	...
	[29] = { -- Sjukhus
		objName = "v_ilev_cor_firedoor",
		objCoords  = {x = -461.720, y = -348.658, z = -187.369},
		textCoords = {x = -461.720, y = -348.658, z = -186.0},
		locked = true,
	},

	[30] = { -- Sjukhus
		objName = "v_ilev_cor_firedoor",
		objCoords  = {x = -463.558, y = -359.672, z = -187.369},
		textCoords = {x = -463.558, y = -359.672, z = -186.0},
		locked = true,
	},

	[31] = { -- Sjukhus
		objName = "v_ilev_cor_firedoor",
		objCoords  = {x = -466.045, y = -354.572, z = -187.369},
		textCoords = {x = -466.045, y = -354.572, z = -186.0},
		locked = true,
	},

	[32] = { -- Sjukhus
		objName = "v_ilev_cor_firedoor",
		objCoords  = {x = -472.321, y = -354.846, z = -187.369},
		textCoords = {x = -472.321, y = -354.846, z = -186.0},
		locked = true,
	},

	[33] = { -- Sjukhus
		objName = "v_ilev_cor_firedoor",
		objCoords  = {x = -475.363, y = -344.321, z = -187.369},
		textCoords = {x = -475.363, y = -344.321, z = -186.0},
		locked = true,
	},

	[34] = { -- Sjukhus
		objName = "v_ilev_cd_door2",
		objCoords  = {x = -449.758, y = -368.490, z = -187.369},
		textCoords = {x = -449.758, y = -368.490, z = -186.0},
		locked = true,
	},

	[35] = { -- Coffe extended station
	    objName = "v_ilev_ph_gendoor006",
	    objCoords  = {x = 465.549, y = -989.468, z = 24.914},
	    textCoords = {x = 465.549, y = -989.468, z = 25.5},
	    locked = true,
	},
	
	[36] = { -- Coffe extended station
	    objName = "v_ilev_ph_gendoor006",
	    objCoords  = {x = 465.496, y = -990.433, z = 24.914},
	    textCoords = {x = 465.496, y = -990.433, z = 25.5},
	    locked = true,
    },
