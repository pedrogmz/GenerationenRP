...
function createNoClipMenuOptions()
    local options = {"Stäng Av: Numpad 5","W = Framåt","S = Bakåt","A = Rotera Vänster","D = Rotera Höger","Q = Flyg Uppåt","Z = Flyg Neråt","Shift = Byt Hastighet"}
    local speeds = { "Saktast", "Saktare", "Sakta", "Normal", "Snabbt", "Snabbare", "Snabbast" }
    local menuOpts = {}
    ...
    local curSpeed = {["menuName"] = "Hastighet = "..(speeds[travelSpeed] or "NA")}
