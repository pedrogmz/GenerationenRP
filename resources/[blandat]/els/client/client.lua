    ...
    while true do
        ...
        if guiEnabled and vehInTable(els_Vehicles, checkCarHash(GetVehiclePedIsUsing(GetPlayerPed(-1)))) then
            if (GetPedInVehicleSeat(GetVehiclePedIsUsing(GetPlayerPed(-1)), -1) == GetPlayerPed(-1)) or
                ...
                _DrawRect(-99999.85, 0.91, 0.24, 0.11, 0, 0, 0, 200, 0)

                if (getVehicleLightStage(GetVehiclePedIsUsing(GetPlayerPed(-1))) == 1) then
                    _DrawRect(-99999.85, 0.88, 0.03, 0.02, 173, 0, 0, 225, 0)
                    Draw("1", 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)
                else
                    _DrawRect(-99999.85, 0.88, 0.03, 0.02, 186, 186, 186, 225, 0)
                    Draw("1", 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)
                end

                if (getVehicleLightStage(GetVehiclePedIsUsing(GetPlayerPed(-1))) == 2) then
                    _DrawRect(-99999.85, 0.88, 0.03, 0.02, 173, 0, 0, 225, 0)
                    Draw("2", 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)
                else
                    _DrawRect(-99999.85, 0.88, 0.03, 0.02, 186, 186, 186, 225, 0)
                    Draw("2", 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)
                end
                ...
                if (getVehicleLightStage(GetVehiclePedIsUsing(GetPlayerPed(-1))) == 3) then
                    _DrawRect(-99999.85, 0.88, 0.03, 0.02, 173, 0, 0, 225, 0)
                    Draw("3", 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)
                else
                    _DrawRect(-99999.85, 0.88, 0.03, 0.02, 186, 186, 186, 225, 0)
                    Draw("3", 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)
                end

                _DrawRect(-99999.85, 0.88, 0.035, 0.02, 186, 186, 186, 225, 0)
                Draw("PRIM " .. tostring(lightPatternPrim), 0, 0, 0, 255, -99999.85, 0.87, 0.25, 0.25, 1, true, 0)

                _DrawRect(-99999.85, 0.91, 0.035, 0.02, 186, 186, 186, 225, 0)
                Draw("SEC " .. tostring(lightPatternSec), 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)

                if (doesVehicleHaveTrafficAdvisor(GetVehiclePedIsUsing(GetPlayerPed(-1)))) then
                    _DrawRect(-99999.85, 0.94, 0.035, 0.02, 186, 186, 186, 225, 0)
                    Draw("ADV " .. tostring(advisorPatternSelectedIndex), 0, 0, 0, 255, -99999.85, 0.93, 0.25, 0.25, 1, true, 0)
                end

                if (h_horn_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 1) then
                    _DrawRect(-99999.85, 0.91, 0.03, 0.02, 0, 173, 0, 225, 0)
                    Draw("HORN", 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)
                else
                    _DrawRect(-99999.85, 0.91, 0.03, 0.02, 186, 186, 186, 225, 0)
                    Draw("HORN", 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)
                end

                if (dualEnable[GetVehiclePedIsUsing(GetPlayerPed(-1))]) then
                    _DrawRect(-99999.85, 0.91, 0.03, 0.02, 0, 213, 255, 225, 0)
                    Draw("DUAL", 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)
                else
                    _DrawRect(-99999.85, 0.91, 0.03, 0.02, 186, 186, 186, 225, 0)
                    Draw("DUAL", 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)
                end
                ...
                if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 11)) then
                    _DrawRect(-99999.85, 0.91, 0.03, 0.02, 255, 0, 0, 255, 0)
                    Draw("TKD", 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)
                else
                    _DrawRect(-99999.85, 0.91, 0.03, 0.02, 186, 186, 186, 225, 0)
                    Draw("TKD", 0, 0, 0, 255, -99999.85, 0.9, 0.25, 0.25, 1, true, 0)
                end
                ...
                if (m_siren_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 1) then
                    if (d_siren_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 1) then
                        _DrawRect(-99999.85, 0.94, 0.015, 0.02, 0, 173, 0, 225, 0)
                    else
                        _DrawRect(-99999.85, 0.94, 0.03, 0.02, 0, 173, 0, 225, 0)
                    end
                else
                    _DrawRect(-99999.85, 0.94, 0.03, 0.02, 186, 186, 186, 225, 0)
                end

                if (d_siren_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 1) then
                    if (m_siren_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 1) then
                        _DrawRect(-99999.85, 0.94, 0.015, 0.02, 0, 213, 255, 225, 2)
                    else
                        _DrawRect(-99999.85, 0.94, 0.03, 0.02, 0, 213, 255, 225, 0)
                    end
                end
                
                Draw("MAIN", 0, 0, 0, 255, -99999.85, 0.93, 0.25, 0.25, 3, true, 0)
                ...
                if (d_siren_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 2) then
                    if (m_siren_state[GetVehiclePedIsUsing(GetPlayerPed(-1))] == 2) then
                        ...
                        _DrawRect(-99999.85, 0.94, 0.03, 0.02, 0, 213, 255, 255, 0)
                    end
                end

                Draw("SEC", 0, 0, 0, 255, -99999.85, 0.93, 0.25, 0.25, 3, true, 0)
                ...
                Draw("AUX", 0, 0, 0, 255, -99999.85, 0.93, 0.25, 0.25, 3, true, 0)

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 7)) then
                    _DrawRect(-99999.85, 0.94, 0.015, 0.015, els_Vehicles[vehN].extras[7].env_color.r, els_Vehicles[vehN].extras[7].env_color.g, els_Vehicles[vehN].extras[7].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.94, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 8)) then
                    _DrawRect(-99999.85, 0.94, 0.015, 0.015, els_Vehicles[vehN].extras[8].env_color.r, els_Vehicles[vehN].extras[8].env_color.g, els_Vehicles[vehN].extras[8].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.94, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 9)) then
                    _DrawRect(-99999.85, 0.94, 0.015, 0.015, els_Vehicles[vehN].extras[9].env_color.r, els_Vehicles[vehN].extras[9].env_color.g, els_Vehicles[vehN].extras[9].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.94, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 1)) then
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, els_Vehicles[vehN].extras[1].env_color.r, els_Vehicles[vehN].extras[1].env_color.g, els_Vehicles[vehN].extras[1].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 2)) then
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, els_Vehicles[vehN].extras[2].env_color.r, els_Vehicles[vehN].extras[2].env_color.g, els_Vehicles[vehN].extras[2].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 3)) then
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, els_Vehicles[vehN].extras[3].env_color.r, els_Vehicles[vehN].extras[3].env_color.g, els_Vehicles[vehN].extras[3].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 4)) then
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, els_Vehicles[vehN].extras[4].env_color.r, els_Vehicles[vehN].extras[4].env_color.g, els_Vehicles[vehN].extras[4].env_color.b, 225, 0)
                else
                    _DrawRect(-99999.85, 0.92, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 5)) then
                    _DrawRect(0.93, -99999.85, 0.015, 0.015, els_Vehicles[vehN].extras[5].env_color.r, els_Vehicles[vehN].extras[5].env_color.g, els_Vehicles[vehN].extras[5].env_color.b, 225, 0)
                else
                    _DrawRect(0.91, -99999.85, 0.015, 0.015, 186, 186, 186, 225, 0)
                end

                if(IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 6)) then
                    _DrawRect(0.93, -99999.85, -99999.85, 0.015, els_Vehicles[vehN].extras[6].env_color.r, els_Vehicles[vehN].extras[6].env_color.g, els_Vehicles[vehN].extras[6].env_color.b, 225, 0)
                else
                    _DrawRect(0.93, -99999.85, -99999.85, 0.015, 186, 186, 186, 225, 0)
                end
            end
        end
        Wait(0)
